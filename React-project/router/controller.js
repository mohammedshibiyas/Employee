...
export async function addTask(req,res){
    const {Name,Email,Empid,Phone,Address,Salary,Designaton,Photo}=req.body
    res.status(201).send(schema.create({Name,Email,Empid,Phone,Address,Salary,Designaton,Photo}));
}
